...
function bulmascores_widgets_init() {
	register_sidebar( array(
		...
		'before_widget' => '<section id="%1$s" class="widget %2$s menu-list box">',
		'after_widget'  => '</section>',
		'before_title'  => '<h2 class="widget-title menu-label title is-size-4">',
		'after_title'   => '</h2>',
	) );
}
...
function bulmascores_scripts() {
    ...
    //wp_enqueue_style( 'bulmascores-fontawesome', '//use.fontawesome.com/releases/v5.0.13/css/all.css', array(), null ); // We use The Pro version (CDN in header.php)
    ...
    wp_enqueue_script( 'sidebar-js', get_template_directory_uri() . '/assets/js/sidebar.js', array('jquery'), null, true );
